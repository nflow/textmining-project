...
#
# Compare one manifesto ('manifesto_base') with list of different manifestos (corpus files are specified in
# 'manifestos' variable)
# The corpus files have to be generated with lda_manifesto.py or lda_spiegel.py first.
#
